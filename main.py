...
if __name__ == "__main__":
    ...
    print(f"Lay stake required to achieve the profit: {abs(overall_stake - sportsbook_stake):.2f}")
    ...
    print(f"Return if Lay wins: {lay_win_return_with_commission - overall_stake :.4f}")
